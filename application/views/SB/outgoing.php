        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('outgoing');?>" class="nav-link active">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="card-title"><b><i class="fa-solid fa-file-export"></i> OUTGOING SUBMISSION</b>
                            </h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 bg-light text-right">
                                <button type="button" id="btnSave1" onclick="save1()"
